...
const initialGameData = {
  ...
  questions: { // 5 perguntas para cada fase
    ...
    5: [
      { question: 'P5-Q1: A ética deontológica, como a de Kant, foca em quê?', answers: ['Nas consequências das ações', 'No dever moral e nas regras universais', 'Nas virtudes do caráter do agente', 'Na busca da felicidade individual'], correct: 1, explanation: 'A deontologia enfatiza o cumprimento do dever moral, independentemente das consequências.' },
      { question: 'P5-Q2: O Utilitarismo, de filósofos como Bentham e Mill, visa o quê?', answers: ['A maior felicidade para o indivíduo que age', 'A conformidade com as leis naturais', 'A maximização da felicidade geral para o maior número de pessoas', 'O desenvolvimento da excelência pessoal'], correct: 2, explanation: 'O princípio da maior felicidade para o maior número é central no Utilitarismo.' },
      { question: 'P5-Q3: Na formação de professores, a reflexão ética é importante para:', answers: ['Apenas para obter certificação', 'Desenvolver a capacidade de tomar decisões justas e responsáveis na prática educativa', 'Ensinar dogmas religiosos', 'Evitar qualquer tipo de conflito'], correct: 1, explanation: 'A ética profissional docente envolve lidar com dilemas e tomar decisões que afetam os alunos.' },
      { question: 'P5-Q4: O que é um "dilema ético" na profissão docente?', answers: ['Uma situação com apenas uma solução clara e fácil', 'Um problema de gestão escolar sem implicações morais', 'Uma situação em que há conflito entre diferentes valores ou princípios morais', 'Uma discordância sobre métodos de ensino'], correct: 2, explanation: 'Dilemas éticos ocorrem quando diferentes valores morais entram em conflito, exigindo uma escolha difícil.' },
      { question: 'P5-Q5: Respeito, justiça e responsabilidade são considerados valores éticos na educação?', answers: ['Sim, são fundamentais', 'Não, a educação deve ser neutra em valores', 'Apenas o respeito é importante', 'Depende da cultura local'], correct: 0, explanation: 'Estes são valores cruciais para um ambiente educacional ético e formativo.' },
    ],
  },
  ranking: [],
};
